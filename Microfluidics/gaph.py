...
fig, ax = plt.subplots()
ax.imshow(np.hstack(slices), extent=[-0.5, 30.5, 2, 0], aspect='auto')
ax.set_xticks(range(0, 31, 1))
ax.scatter(range(0, 31, 1), positions, color='red')
...
ax.plot(func(np.linspace(0, infunc(31*60, *popt), 100), *popt)/60, np.linspace(0, infunc(31*60, *popt), 100), color='red')
