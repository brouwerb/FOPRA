...
Microfluidic devices are a great substitute for big and costly lab setups, as many different functions can be implemented on a single chip. In this Lab course we manufacture a basic microfluidic chip and use it to measure the diffusion constant of agarose with a FITC solution.

\section{Theoretical Considerations}

Bei der Beobachtung von Microfluidics stellt man signifikante Unterschiede zu Makroskopischen Flüssigkeitsmengen Fest. Diese Unterscheide entstehen, da in der mikosopischen welt andere Effekte, wie die Elektrostatik oder auch die Grenzflächenspannung gegenüber z.B. der Gravitation im makroskopischen doiminieren. Dabeio ist besinders zu beachten, dass mikrofluidics immer laminare Strömungen aufweisen und keine turbulentn Ströme auftreten. Zu erkennne ist dies an der immer sehr geringen Reynoldszahl. 
